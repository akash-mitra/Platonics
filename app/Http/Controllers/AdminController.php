...
class AdminController extends BaseController
{
	...
	{
		if (!$this->checkPageActionPermissions('delete')) return redirect()->route('page-index');
	...
	{
		if (!$this->checkCategoryActionPermissions('create')) return redirect()->back();
	...
	{
		if (!$this->checkCategoryActionPermissions('store')) return redirect()->back();
	...
	{
		if (!$this->checkCategoryActionPermissions('edit')) return redirect()->back();
	...
	protected function saveCategory(Request $request)
	{
		...
		if (!$this->checkCategoryActionPermissions('save')) return redirect()->back();

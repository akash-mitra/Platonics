...
class BladeHelper {
	...
	public static function buildHTMLListfromTree (
		array $tree,          // a tree structure such as returned by buildTree()
		$level = 0,           // a value indicating the first level of the tree, usually 0
		$linkParent = true,   // whether to use HTML anchor tag with parent elements containing sublist
		$maxLevel = -1,       // max-level till which recursion needs to run
		$treeTag = 'ul',      // HTML tag to be used for denoting List

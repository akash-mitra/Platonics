    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#upload" role="tab">Upload New Image</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#album" role="tab">Choose from Album</a>
          </li>
        </ul>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Upload and Add</button>
      </div>
    </div>
  </div>
</div>
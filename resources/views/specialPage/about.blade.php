...
<div class="row mb-1">
	<div class="col-md-12">
		<div class="float-left">
			<h3>About Page</h3>
			<p>Provide as much information as you wish about yourselves. This section is shown in the front page</p>
		</div>
    </div>
</div>
...
@section('page.script')
    ...
    <script>
        ...
        var aboutBody = new MediumEditor('#pageBody', {
			...
			placeholder: { text: 'I want to be your favorite hello and your hardest goodbye :-)' }
        });
        ...
        var saveContents = function () {
			...
			makeAjaxRequest ({
				method: "post",
				data: data,
				to: "{{route('special-pages-about-save')}}",
				before: function () {
